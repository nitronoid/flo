...
void test(std::string name)
{
  ...
  HostVectorI h_adjacency = d_adjacency;
  HostVectorI h_adjacency_keys = d_adjacency_keys;
  ...
  auto expected_adjacency_keys =
    read_host_vector<int>(mp + "/vertex_triangle_adjacency/adjacency_keys.mtx");
  auto expected_adjacency =
    read_host_vector<int>(mp + "/vertex_triangle_adjacency/adjacency.mtx");
  auto expected_valence =
    read_host_vector<int>(mp + "/vertex_triangle_adjacency/valence.mtx");
